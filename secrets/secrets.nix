let
  ...
  personal = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIB5uIM8ETO5SA5oJcaf5UijIjvyJWMlqavMxYaG41zOg not-matthias@pc";
  pc = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIE7YoF9FIUMehVpS/vwGWPQCEOlxhfQzvnNA93ybgvvS root@pc";
  ...
  systems = [laptop desktop personal pc recovery_key];
in {
