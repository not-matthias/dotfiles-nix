...
5. **Over-engineering?** Did you add abstractions, configurability, error handling, or future-proofing that isn't needed for the current task? Three similar lines of code is better than a premature abstraction.
6. **Tests still pass?** If the project has tests, run them. If any fail due to your changes, fix them before finishing.
