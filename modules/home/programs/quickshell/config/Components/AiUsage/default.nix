{pkgs}: let
  ...
  mkUsageScript = name: script:
    ...
    '';
in {
  claudeScript = mkUsageScript "quickshell-claude-usage" ./scripts/claude-usage.sh;
  codexScript = mkUsageScript "quickshell-codex-usage" ./scripts/codex-usage.sh;
  antigravityScript = mkUsageScript "quickshell-antigravity-usage" ./scripts/antigravity-usage.sh;
}
