_self: super: {
  ...
  ida-pro = super.callPackage ./ida-pro.nix {
    plugins = with _self; [ida-nexus ida-mcp ida-codemode bindiff-ida binsync-ida ida-theme-explorer ida-wakatime ida-guides ida-sigmaker ida-structor ida-lifter];
