...
stdenv.mkDerivation rec {
  ...
  in
    builtins.fetchurl {
      ...
      sha256 = "sha256:18ah4ayn2a9hbqj426r3p1kj1hw6s0j943slqzlfmmljh9ckwkvf";
    };
  ...
  meta = with lib; rec {
    ...
    longDescription = ''
      ...
      For example:
      ```shell
      ln -s /run/current-system/sw/bin/copilot-agent ~/.local/share/JetBrains/CLion2022.3/github-copilot-intellij/copilot-agent/bin/copilot-agent-linux
      ```
    '';
